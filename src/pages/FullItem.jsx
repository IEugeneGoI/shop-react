        ...
        async function fetchItem() {
            try {
                const { data } = await axios.get(
                    "https://6492e040428c3d2035d0d69d.mockapi.io/products/" + id
                );
                setItem(data);
            } catch (error) {
    ...
    return (
        <div className="container">
            ...
            <div className="fullitem__content">
                <img src={item.imageUrl} className="fullitem__picture" alt=""/>
            ...
            <h2 className="fullitem__titleSlider">
            ...
            {!isScreenMomile && !isScreenMd && (
                <Slider slides={items} quant={2} />
            )}
